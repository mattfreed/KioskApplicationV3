...
public class EmergencySelectRoomController extends RequestController {
    String floor = "3";
     ...
     */
    public void submitRequest(ActionEvent actionEvent) throws Exception {
        if (selectedLocation == null) {
            errorLabel.setText("Please Select a pickup location");
        } else {
            Emergency emergency = new Emergency();
            emergency.setRecipient("goldgermans@gmail.com");
            emergency.setSender("goldgermans@gmail.com");
            emergency.setSenderPassword("SoftEngTeamG!");
            emergency.run(50, 50, 1900, 1000, null, selectedLocation.getLongName(),
                    selectedLocation.getLongName());
        }
    }
}
