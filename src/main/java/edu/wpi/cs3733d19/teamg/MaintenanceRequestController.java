...
public class MaintenanceRequestController extends RequestController {
    ...
    public void setFloor() {
        ...
        for (Node node : selectable) {
            JFXButton btndest = new JFXButton();
            btndest.setText(node.getShortName());
            btndest.setOnAction(this::destHandler);
            btndest.setMinWidth(250);
            btndest.setTextAlignment(TextAlignment.LEFT);
            btndest.setId(node.getNodeId());
    ...
    public void submitRequest(ActionEvent actionEvent) throws IOException {
        if (selectedLocation == null) {
            ...
            MaintenanceRequest request =
                    new MaintenanceRequest(selectedLocation, KioskApplication.getCurrentUser(),
                            new Date(),reasonTextField.getText(), em);
    ...
    private void destHandler(ActionEvent event) {
        ...
        roomNumberLabel.setText(btn.getText());
    }
}
